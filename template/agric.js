        ...
        success: function(freelancers){
            ...
            $.each(freelancers, function(i, freelancer){
                ...
                $free.append(
                    ...
                    "<div class='col-sm-6 card shadow-sm p-3 mb-5 bg-white rounded' style='width: 18rem; margin-right:50px; margin-bottom:50px'>"+
                    "<!--<img class='card-img-top' src='../images/agric.jpg' style='width: 18rem;' alt='Card image cap'>-->"+
